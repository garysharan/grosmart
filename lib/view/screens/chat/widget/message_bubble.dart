...
import 'package:grosmart/data/model/response/chat_model.dart';
...
import 'package:grosmart/view/screens/chat/widget/image_dialog.dart';
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          '${_profileProvider.userInfoModel.fName} ${_profileProvider.userInfoModel.lName}',
                          style: poppinsRegular.copyWith(
                              fontSize: Dimensions.FONT_SIZE_LARGE),
                        ),
                        SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                              ...
                              child: CircleAvatar(
                                ...
                                child: ClipRRect(
                                  child: FadeInImage.assetNetwork(
                                    ...
                                    height: 40,
                                    image:
                                        '${Provider.of<SplashProvider>(context, listen: false).baseUrls.customerImageUrl}/${_profileProvider.userInfoModel.image}',
                                    imageErrorBuilder: (c, o, s) => Image.asset(
